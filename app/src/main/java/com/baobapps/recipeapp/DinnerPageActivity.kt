...
class DinnerPageActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dinner_page) // Declare the View for user
        ...
        bottomNavigationView.selectedItemId = R.id.page_dinner
